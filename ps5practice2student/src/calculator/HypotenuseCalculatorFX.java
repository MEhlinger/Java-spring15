...
public class HypotenuseCalculatorFX extends Application {
    ...
    DecimalFormat resultFormat = new DecimalFormat("###,###.0000");
    ...
    public void start(Stage primaryStage) {
        ...
        btn.setOnAction((ActionEvent e) -> {
                double fieldA = Double.parseDouble(tfA.getText());
                double fieldB = Double.parseDouble(tfB.getText());
                tfC.setText(resultFormat.format(calcHypoteneuse(fieldA, fieldB)));
        });
    ...
    private double calcHypoteneuse(double a, double b) {
