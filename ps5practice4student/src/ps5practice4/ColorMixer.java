...
public class ColorMixer extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btn.setStyle("-fx-font-size: 24pt");
        btn.setOnAction(e -> {
            mixColors();
        });
        ...
        hBoxBottom.getChildren().addAll(rect, btn);
    ...
    private void mixColors() {
        ...
        rgb[0] = Integer.parseInt(tfRed.getText());
        rgb[1] = Integer.parseInt(tfGreen.getText());
        rgb[2] = Integer.parseInt(tfBlue.getText());
        ...
        for (int i = 0; i < rgb.length; i++) {
         ...
         tfRed.setText(Integer.toString(rgb[0]));
         tfGreen.setText(Integer.toString(rgb[1]));
         tfBlue.setText(Integer.toString(rgb[2]));
